...
import { Avatar, AvatarFallback, AvatarImage } from "../../ui-lib/Avatar/Avatar"
...
export const UserMenu = ({picture, currentUser}: Props) => {
    ...
    return (
        <div className="flex justify-center items-center gap-10 cursor-pointer p-2 rounded-md bg-primary-900/15 hover:bg-main transition-all">
