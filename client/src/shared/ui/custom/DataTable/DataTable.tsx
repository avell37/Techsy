...
import { 
    ...
    TableHeader, 
    TableRow 
} from "../../external/Table/Table"
import { useState } from "react"
import { Input } from "../../external/Input/Input"
        ...
        <div>
            {filterKey && (
                <div className="flex items-center py-4">
                    ...
                    className="max-w-sm border border-primary-900/40 hover:border-primary-900 text-white w-full"
                    />
            </div>
            )}
