...
import { useCartDevice } from "../../model/hooks/useCartDevice";
import type { CartDeviceSchema } from "../../model/types/CartSchema";
...
export const CartDevice = ({
    ...
    const { handleNavigate, handleDecrementDevice, 
        handleIncrementDevice, handleDeleteCartDevice 
    } = useCartDevice(device);
    ...
    return (
        ...
        >
            <div
                className="flex flex-1 gap-4 items-center cursor-pointer w-full max-sm:flex-col max-sm:items-start"
            ...
            <div className="flex items-center gap-4 mt-4 sm:mt-0 max-sm:items-start max-sm:flex">
                ...
                <div className="flex items-center gap-2">
                    ...
                    >
                        <X className="stroke-white size-5" />
                    </Button>
                </div>
            </div>
        </div>
