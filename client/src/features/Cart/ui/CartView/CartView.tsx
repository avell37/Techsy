...
export const CartView = ({
    ...
    return (
        <div className="flex flex-col justify-between gap-[30px] h-full">
            <div>
                <Button
                    onClick={() => openModal("manageAddress")}
                    className="min-h-[50px] w-full border-[2px] border-[#3A177F] rounded-xl hover:border-[#8A4FFF] 
                hover:bg-[#1A1238]/30 transition-all text-white max-w-[300px] cursor-pointer"
